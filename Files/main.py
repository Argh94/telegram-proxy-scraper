...
def fetch_proxies_from_text_urls(urls):
    ...
    # رجکس اصلاح‌شده برای شناسایی پروکسی‌ها
    pattern = r'^(tg://proxy|https://t\.me/proxy)\?server=[^&]+&port=\d+&secret=[a-fA-F0-9]+.*$'
...
if __name__ == "__main__":
    text_urls = [
        ...
        "https://raw.githubusercontent.com/SoliSpirit/mtproto/master/all_proxies.txt"  # URL خام
    ]
